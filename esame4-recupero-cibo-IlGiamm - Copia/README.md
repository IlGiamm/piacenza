...
# Exam #4: "Recupero Cibo"
## Student: s301140 Greco Giacomo 

## React Client Application Routes

- Route `/`: mostra la tabella con tutti i ristoranti che aderiscono
- Route `/login`:pagina per il login, contiene il form per l'autenticazione
