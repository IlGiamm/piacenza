...
const restaurantDao = require('./daos/dao-Ristoranti'); 
...
// 1. Retrieve the list of the restaurants
// GET /api/:Ristoranti
// This route returns All the ristoranti.
app.get('/api/ristoranti',
  (req, res) => {

    restaurantDao.listAllRestaurant()
      .then(ristoranti => res.json(ristoranti))
